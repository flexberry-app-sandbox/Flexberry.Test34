namespace Test.WebAPI
{
    ...
    public class Startup
    {
        ...
        public void ConfigureContainer(IUnityContainer container)
        {
            ...
            TestCurrentUserService currentUserService = new (container.Resolve<IHttpContextAccessor>(), container.Resolve<IDataService>());

            container.RegisterInstance<ITestCurrentUserService>(currentUserService);
