namespace Test.WebAPI.Controllers
{
    ...
    using Test.ApplicationLayer.DTO.File;
    ...
    public partial class FileController : ControllerBase
    {
        ...
        private readonly ITestCurrentUserService _currentUserService;
        ...
        public FileController(IConfiguration configuration, ITestCurrentUserService currentUserService)
        {
