namespace Test.ApplicationLayer.Services
{
    ...
    /// </summary>
    public class TestCurrentUserService : ITestCurrentUserService
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestCurrentUserService"/> class.
        /// </summary>
        /// <param name="httpContextAccessor">Доступ к текущему контексту.</param>
        /// <param name="dataService">Сервис для вычитки данных.</param>
        public TestCurrentUserService(IHttpContextAccessor httpContextAccessor, IDataService dataService)
        {
